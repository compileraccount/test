...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("rushcoin");
    QApplication::setOrganizationDomain("rushcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("rushcoin-Qt-testnet");
    else
        QApplication::setApplicationName("rushcoin-Qt");
